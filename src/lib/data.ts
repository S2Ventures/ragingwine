...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    subtitle: 'Marina Pizza With Wine That\'s Barely a Footnote',
    tags: ['Marina', 'Pizza', 'Quick Service', 'Lake Burton', 'Grab and Go'],
    editorial: [
      {
        title: 'The Wine List',
        body: 'Billy Goat Island is a grab-and-go pizza counter at LaPrade\'s Marina on Lake Burton. Wine is available in the same way that ketchup is available: it\'s there if you ask, but it\'s not why you showed up. The selection is minimal, the format is counter service, and the focus is getting hot pizza to people heading back to the boat.',
      },
      {
        title: 'Why Lazy List',
        body: 'A marina pizza counter with virtually no wine program. Billy Goat Island is reviewed because it serves food in Clayton, but the wine conversation here is one sentence long: there isn\'t one. Grab a slice and a beer and enjoy the lake.',
      },
    ],
    bottomLine: 'Billy Goat Island is marina pizza. Grab a slice, crack a beer, and watch the boats. Wine is not part of the equation.',
    publishedAt: '2026-02-16',
  },
  // ── Blue Ridge, Georgia ───────────────────────────────────────
  {
